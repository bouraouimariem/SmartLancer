...
<title>Bienvenue Freelancer</title>
...
<script>
setTimeout(() => {
    window.location.href = "/project/index.php?route=profil";
...
<div class="text-center fade">
    ...
    <p class="text-xl opacity-90 mb-8">Chargement de votre espace Freelancer...</p>
