                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo" style="text-align: left; margin-top: 10px;">
                                   <a href="index.php">
    <img src="img/logo.png?v=<?php echo time(); ?>" 
         alt="logo" 
         width="100">
    <h1 style="font-family: 'Poppins', sans-serif; font-size: 20px; color: white; margin-left: -20px;">
        SmartLancer
    </h1>
</a>
                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="pages/reclamation.php">reclamation</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6">
                        <div class="slider_text">
                            <h5 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s">4536+ pages/projet listed</h5>
            ...
            <div class="job_lists">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="single_# white-bg d-flex justify-content-between">
                            <div class="#_left d-flex align-items-center">
                                <div class="thumb">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            <div class="footer_logo"  style="text-align: left;">
                                <a href="#">
                                    <img src="img/logo.png" alt="" width="80">
                                    <h1 style="font-family: 'Poppins', sans-serif; font-size: 24px;color: white; margin-left: 10px; height: 20%;">lanci</h1>
                                </a>
                            </div>
                            <p>
